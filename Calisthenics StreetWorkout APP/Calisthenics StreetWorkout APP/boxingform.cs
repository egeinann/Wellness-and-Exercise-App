...
{
    public partial class boxingform : Form
    {
        private Timer timer;
        ...
        private void boxingform_Load(object sender, EventArgs e) // FORMLOAD
        {
        ...
        private void button4_Click(object sender, EventArgs e) // REFRESHBUTTON1
        {
            ...
            countdownSeconds = 90; // 30 dan başla
            pictureBox4.Visible = false;
            pictureBox5.Visible = true;
        ...
        private void button1_Click(object sender, EventArgs e) // STARTBUTTON4
        {
