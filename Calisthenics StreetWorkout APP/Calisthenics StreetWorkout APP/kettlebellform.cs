...
{
    public partial class kettlebellform : Form
    {
        private Timer timer;
        private int countdownSeconds = 60;
        public kettlebellform()
        {
            InitializeComponent();
        }
        ...
        {
            if (timer1.Enabled == true || timer2.Enabled == true || timer3.Enabled == true) // eğer zamanlayıcılar aktif ise çıkış tuşunu engelle
            {
        ...
        private void kettlebellform_Load(object sender, EventArgs e) // FORMLOAD
        {
        ...
        private void button7_Click(object sender, EventArgs e) // STARTBUTTON1
        {
        ...
        private void button4_Click(object sender, EventArgs e) // REFRESHBUTTON1
        {
            ...
            pictureBox4.Visible = false;
            pictureBox5.Visible = true;
            label14.Text = progressBar1.Maximum.ToString();
        ...
        private void timer1_Tick(object sender, EventArgs e) // TİMER1
        {
            ...
            if (countdownSeconds >= progressBar1.Minimum)
            {
                ...
                label14.Text = countdownSeconds.ToString();
            }
            else
            {
                timer1.Stop();
        ...
        private void button5_Click(object sender, EventArgs e) // REFRESHBUTTON2
        {
            ...
            pictureBox6.Visible = false;
            pictureBox7.Visible = true;
            label13.Text = progressBar2.Maximum.ToString();
            button3.Enabled = true;
        ...
        private void timer2_Tick(object sender, EventArgs e) // TİMER2
        {
            ...
            if (countdownSeconds >= progressBar2.Minimum)
            {
                ...
                label13.Text = countdownSeconds.ToString();
            }
            else
            {
                timer2.Stop();
        ...
        private void button3_Click(object sender, EventArgs e) // STARTBUTON3
        {
