...
{
    public partial class lowerbodystretching : Form
    {
        private Timer timer;
        private int countdownSeconds = 30;
        public lowerbodystretching()
        {
            InitializeComponent();
        }
        ...
        private void lowerbodystretching_Load(object sender, EventArgs e) // ana form yüklendiğinde...
        {
